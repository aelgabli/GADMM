function [obj_GADMM, loss_GADMM, Iter, gadmm_time, com_cost]=dynamic_group_ADMM_closedForm_v0(XX,YY, rho, no_workers, num_feature, noSamples, num_iter, obj0...
    , acc, path_matrix, pathCost_matrix, coherence_Time)
